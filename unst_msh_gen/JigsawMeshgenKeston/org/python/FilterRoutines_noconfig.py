...
#-- remap a DEM on to the vertices of the mesh
    ...
    print("*interp-batyhmetry...")
        ...
        # Load the DEM file from the config
    dem_file = "RTopo_2_0_4_GEBCO_v2023_60sec_pixel.nc"
...
if (__name__ == "__main__"):
   ...
   # configurations = load_configuration(args.config)
    ...
    mesh = jigsawpy.jigsaw_msh_t()
    jigsawpy.loadmsh("mesh_1kmUSCL_15kmOO.msh", mesh)
    ...
    jigsawpy.savemsh("mesh_1kmUSCL_15kmOO_FltOcn.msh", mesh)
# convert to lon lat    
    ...
    interp_bathymetry()
    jigsawpy.savemsh("mesh_1kmUSCL_15kmOO_FltOcnLLH.msh", mesh)
