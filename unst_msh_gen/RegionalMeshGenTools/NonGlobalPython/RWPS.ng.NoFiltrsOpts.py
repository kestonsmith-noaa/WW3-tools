...
PSLGFile="../RWPS/Data/DerivativeData/mshfiles/PSLGboundary5km_shifted.msh" 

#jigsaw .msh format gridded distance to coast data in km
DistanceToCoastFile="../RWPS/Data/DerivativeData/mshfiles/DistToUScoast_GSHHS_Wbanks_shifted.msh"

#jigsaw .msh format gridded bathymetry data in m
TopographyFile="../RWPS/Data/DerivativeData/mshfiles/topo_shifted.msh"

# directory to write output files to
OutDir='output/'

ww3_mesh_file='RWPS.ww3'
...
from FilterRoutinesNMorginal import *
#ww3_mesh_file='RWPS.ww3'
#OutDir='output/
...
mesh=meshR2
interp_bathymetry( ) # add add hdown to meshR2.value
jigsawpy.savemsh(OutDir+"RWPS.F.LL.H.msh", mesh)
